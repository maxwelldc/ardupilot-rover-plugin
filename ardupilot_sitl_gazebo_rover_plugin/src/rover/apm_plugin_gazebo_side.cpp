...
bool ArdupilotSitlGazeboRoverPlugin::init_gazebo_side(physics::WorldPtr world, sdf::ElementPtr sdf)
{
    ...
    this->velSub = _rosnode->subscribe(topicNameBuf.c_str(), 100, &ArdupilotSitlGazeboRoverPlugin::OnVelMsg, this);
...
double ArdupilotSitlGazeboRoverPlugin::get_collision_radius(physics::CollisionPtr _coll)
{
...
void ArdupilotSitlGazeboRoverPlugin::on_rover_model_loaded(){
...
*/
void ArdupilotSitlGazeboRoverPlugin::OnVelMsg(const mav_msgs::CommandMotorSpeed msg)
{   
    if (roverSpawn){
